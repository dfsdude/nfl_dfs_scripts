...
def run():
    ...
    if roo_projections_file and matchup_file and lineups_file:
        try:
            ...
            # Standardize DST names (DraftKings uses full team names, but our data uses abbreviations)
            dst_name_to_short = {
            ...
            # Apply DST name standardization to the DST column
            lineups_df['DST'] = lineups_df['DST'].replace(dst_name_to_short)
